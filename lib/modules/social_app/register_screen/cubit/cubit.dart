...
class SocialRegisterCubit extends Cubit<SocialRegisterStates> {
  ...
  useRegister({String? name, String? email, String? password, String? phone}) {
    ...
    FirebaseAuth.instance
        ...
        .then((value) {
      createUser(name: name, phone: phone, email: email, uId: value.user!.uid , password: password);
  ...
  createUser({String? name, String? email, String? phone, String? uId , dynamic password}) {
    SocialUserModel? socialUserModel =
        SocialUserModel(email: email, phone: phone, name: name, uId: uId,password: password,isEmailVerified: false);
